...
GrassObject = function ()
{
	...
	this.scaleUp = new THREE.Vector3(4.5,4.5,4.5);
	this.scaleDown = new THREE.Vector3(0.1,0.1,0.1);
	this.init = function(material,creator,scene,parent,radius,angleY,angleX,addToArray)
	{
		var createdOnSphere = creator.createThreePlanes(material,new THREE.Vector3(0,0,0),scene,3);
